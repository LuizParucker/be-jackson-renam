...
class ProjectApi {
    async createProject(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao criar/identificar o projeto ${e.message}`})
        }
    }
    ...
    async updateProject(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao realizar alteração no teste ${e.message}`})
        }
    }
    ...
    async deleteProject(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao excluir o teste  ${e.message}`})
        }
    }
    ...
    async findProjects(req, res) {
        try {
            ...
            return res.status(400).send({ error: `Erro ao identificar os Projetos  ${e.message}`})
        }
    }
