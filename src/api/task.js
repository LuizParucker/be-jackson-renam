...
class TaskApi {
    ...
    async createTask(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao criar atividade ${e.message}`})
        }
    }
    ...
    async updateTask(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao alterar atividade${e.message}`})
        }
    }
    ...
    async deleteTask(req, res) {
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao deletar atividade ${e.message}`})
        }
    }
    ...
    async findTasks(req, res) {
        try {
            ...
            return res.status(400).send({ error: `Erro ao listar atividade ${e.message}`})
        }
    }
    ...
    async filterTask(req, res){
        ...
        try {
            ...
            return res.status(400).send({ error: `Erro ao filtrar atividade ${e.message}`})
        }
