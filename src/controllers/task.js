...
class TaskController {
    async createTask(titulo, descricao, id_projeto) {
        if (titulo === undefined || 
            ...
            throw new Error('Título, Descrição, Status e id_projeto são campos obrigatórios.')
        }
    ...
    async update(id, titulo, descricao, status, id_projeto) {
        if (id === undefined || 
            ...
            status === undefined || 
            id_projeto === undefined) {
            throw new Error('Id, título, Descrição, Status e id_projeto são campos obrigatórios.')
        }
